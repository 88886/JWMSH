namespace JWMSH
{
    partial class WmsRibbonMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            ultraExplorerBarItem73.Settings.AppearancesSmall.Appearance = appearance3;
            ultraExplorerBarItem73.Text = "产成品BOM管理";
            ultraExplorerBarItem74.Key = "产成品BOM查询";
            appearance4.Image = "item.gif";
            ultraExplorerBarItem74.Settings.AppearancesSmall.Appearance = appearance4;
            ultraExplorerBarItem74.Text = "产成品BOM查询";
            ultraExplorerBarItem75.Key = "班次制令单";
            appearance5.Image = "item.gif";
            ultraExplorerBarItem75.Settings.AppearancesSmall.Appearance = appearance5;
            ...
            ultraExplorerBarItem79.Settings.AppearancesSmall.Appearance = appearance7;
            ultraExplorerBarItem79.Text = "产成品拆箱";
            ultraExplorerBarItem42.Key = "产成品出库指令单";
            appearance8.Image = "item.gif";
            ultraExplorerBarItem42.Settings.AppearancesSmall.Appearance = appearance8;
            ultraExplorerBarItem42.Text = "产成品出库指令单";
            ultraExplorerBarItem43.Key = "打印调拨单";
            appearance9.Image = "item.gif";
            ultraExplorerBarItem43.Settings.AppearancesSmall.Appearance = appearance9;
            ultraExplorerBarItem43.Text = "打印调拨单";
            ultraExplorerBarItem44.Key = "打印盘点单";
            appearance10.Image = "item.gif";
            ultraExplorerBarItem44.Settings.AppearancesSmall.Appearance = appearance10;
            ...
            ultraExplorerBarItem9.Settings.AppearancesSmall.Appearance = appearance13;
            ultraExplorerBarItem9.Text = "班次领料单明细表";
            ultraExplorerBarItem10.Key = "原料领料出库明细表";
            appearance14.Image = "item.gif";
            ultraExplorerBarItem10.Settings.AppearancesSmall.Appearance = appearance14;
            ultraExplorerBarItem10.Text = "原料领料出库明细表";
            ultraExplorerBarItem11.Key = "产成品标签打印记录表";
            appearance15.Image = "item.gif";
            ultraExplorerBarItem11.Settings.AppearancesSmall.Appearance = appearance15;
            ...
            ultraExplorerBarItem25.Settings.AppearancesSmall.Appearance = appearance17;
            ultraExplorerBarItem25.Text = "产成品入库明细表";
            ultraExplorerBarItem26.Key = "产成品出库指令单明细表";
            appearance18.Image = "item.gif";
            ultraExplorerBarItem26.Settings.AppearancesSmall.Appearance = appearance18;
            ultraExplorerBarItem26.Text = "产成品出库指令单明细表";
            ultraExplorerBarItem28.Key = "产成品出库明细表";
            appearance19.Image = "item.gif";
            ultraExplorerBarItem28.Settings.AppearancesSmall.Appearance = appearance19;
            ...
            ultraExplorerBarItem92.Settings.AppearancesSmall.Appearance = appearance24;
            ultraExplorerBarItem92.Text = "表格样式维护";
            ultraExplorerBarItem93.Key = "用户管理";
            appearance25.Image = "item.gif";
            ultraExplorerBarItem93.Settings.AppearancesSmall.Appearance = appearance25;
            ultraExplorerBarItem93.Text = "用户管理";
            ultraExplorerBarItem94.Key = "角色权限管理";
            appearance26.Image = "item.gif";
            ultraExplorerBarItem94.Settings.AppearancesSmall.Appearance = appearance26;
            ultraExplorerBarItem94.Text = "角色权限管理";
            ultraExplorerBarItem6.Key = "标签模版维护";
            appearance27.Image = "item.gif";
            ultraExplorerBarItem6.Settings.AppearancesSmall.Appearance = appearance27;
            ...
            ultraStatusPanel5.Appearance = appearance28;
