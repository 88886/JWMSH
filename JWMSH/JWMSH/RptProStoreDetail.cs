...
namespace JWMSH
{
    public partial class RptProStoreDetail : Form
    {
        public RptProStoreDetail()
        {
            InitializeComponent();
        }

        private void RptProStoreDetail_Load(object sender, EventArgs e)
        {
        ...
        private void biSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            var strTemp = bfun.GetWhereSqlStr("ProStoreDetail");
